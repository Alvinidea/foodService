  ...
  <body>
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加用户','../admin/mem/member_add')"><i class="layui-icon"></i>添加</button>
        ...
        <tbody>
          <tr>
            ...
            <td class="td-manage">
              ...
              <a title="编辑"  onclick="x_admin_show('编辑','../admin/mem/member_edit')" href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
              </a>
